...
class ComagicHandler(ComagicClient):
    ...
    def __init__(self, login, password, first_call_date, token):
    ...
    def get_calls_report(self, date_from, date_till):
        ...
        класса Connector или берет по умолчанию.lli
        ...
        # ]
        # fields = ['id', 'employee', 'is_lost', 'is_answered',
        #           'is_talked', 'start_time', 'finish_time', 'talk_duration', 'clean_talk_duration',
        #           'visitor_type', 'visits_count',
        #           'utm_source', 'utm_medium', 'utm_campaign', 'utm_content'
        # ]

        fields = ['id', 'start_time', 'finish_time', 'finish_reason', 'direction', 'source',
          'is_lost', 'wait_duration', 'total_wait_duration', 'talk_duration', 'clean_talk_duration',
          'total_duration', 'attributes', 'employees']
    ...
    def get_call_legs_report(self, date_from, date_till):
        """Получение отчета по звонкам с дополнтиельными параметрами за период.
        В качетве параметров принимает дату начала отчета и дату завершения
        отчета.
        ...
        fields = ['call_session_id', 'direction', 'is_failed', 'total_duration',
              'employee_id', 'employee_full_name', 'start_time']
